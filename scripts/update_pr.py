...
# Do NOT hardcode tokens in source. Provide a token via environment variable.
...
'''
if not token:
    raise RuntimeError('GITHUB_TOKEN (or GH_TOKEN) must be set in environment to run this script')
